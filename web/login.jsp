...
<html>
    ...
    <body class="register-page full-screen sidebar-collapse">
        ...
        <!-- End Navbar -->
        <div class="wrapper">
            <div class="page-header" style="background-image: url('assets/img/login-bg.jpg');">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 ml-auto mr-auto">
                            <div class="card card-register">
                                ...
                                <div class="social">
                                    ...
                                    <a href="https://accounts.google.com/o/oauth2/auth?scope=email&redirect_uri=${baseURL}/Login&response_type=code
